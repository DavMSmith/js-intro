...
// NAN
// undefined
// Operators work the exact same way as in Ruby
// + - * / % ()
// >< == === != <= >=
//   3== '3' true
// 3=== '3' triple equal signs signify true in amount and data type. 
// // || &&
...
// multiple word typed as camelCase
// can have a letter, number, _ , $
// have to start with a letter, _, $
// stay away from reserve words, class, var, String
// be descriptive with variable names
// Old way...
// Remember, single equal sign is assignment
// case sensitive (capital "B" Balance is different from "b" balance)
var balance = 1000
// console.log (Balance)
// balance = 900
console.log(balance)
// don't use var because it does something wierd to scope

// if (...) {
//   var balance = 4000 
// } else { -not used any more. 
//scope this is going to be where it is defined
// const - should not change items that you are assigning (should be a constant)
...
//hashes
//objects - noun, items and tools (the console and main web page also objects)
//the best ways to represent objects...
// hashes, 
// JSON
// class
//how to grab information from hashes...
